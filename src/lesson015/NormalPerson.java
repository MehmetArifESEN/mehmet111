...
public class NormalPerson extends Person {
	...
	public String toString() {
		return "NormalPerson [getNormalPersonNumber()=" + getNormalPersonNumber() + ", getName()=" + getName()
				+ ", getSurname()=" + getSurname() + ", getAge()=" + getAge() + "]";
	}
	
	public void bilgileriGoster() {
		System.out.println("Normal person referansı çalıştı-----> " + getNormalPersonNumber());
	}
