...
import lesson018.Hasta.ESikayet;
...
public class AcilServis {
	public static void main(String[] args) {
		...
		Queue<Hasta> acilServis3 = new LinkedList<Hasta>();

		acilServis2.offer(new Hasta("Mustafa", ESikayet.APANDIST));
		acilServis2.offer(new Hasta("Oguz", ESikayet.APANDIST));
		acilServis2.offer(new Hasta("Kemal", ESikayet.AGRI));
		acilServis2.offer(new Hasta("Ayşe", ESikayet.YANIK));
		acilServis2.offer(new Hasta("Zeliha", ESikayet.YANIK));
		acilServis2.offer(new Hasta("Okan", ESikayet.APANDIST));
		acilServis2.offer(new Hasta("Orhan", ESikayet.YANIK));
